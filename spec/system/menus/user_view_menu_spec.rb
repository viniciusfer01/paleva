...
describe "User sees menu items" do
  ...
  it 'and does not see inactive dishes' do 
    ...
    store.menus.create!(name: 'Jantar')     
    dish = menu.dishes.create!(name: 'Pizza', description: 'Prato Italiano, que serve 3 a 4 pessoas', calories: 1200, store: store)
    menu.dishes.create!(name: 'Feijoada', description: 'Comida típica da cozinha Brasileira, serve 3 a 4 pessoas', 
                 calories: 1500, store: store, status: 'inactive')
    beverage = menu.beverages.create!(name: 'YoPro', description: 'Bebida para o público fit sabor chocolate', 
